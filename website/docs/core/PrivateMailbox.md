...
5. **Authenticator**. Test 2FA and TOTP using your account. (link needed)
6. **Single Sign On**. Entperise plans offer single sign on access. (link needed)
7. **Team Members**. Paid plans offer the ability to have multiple team members use the same account.&#x20;
